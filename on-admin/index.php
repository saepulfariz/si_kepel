  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Kantor PLN Cabang Subang</li>
      </ol>
    </section>
   ...
   <!-- Main content -->
        ...
        <section class="content">
          ...
          <div class="box">
            ...
            <div class="box-body">
             <b>Sejarah Singkat Tentang Perusahaan PLN</b> Perusahaan Listrik Negara (disingkat PLN) atau nama resminya adalah PT PLN (Persero) adalah sebuah BUMN yang mengurusi semua aspek kelistrikan yang ada di Indonesia. Dalam pelayanan pendistribusian kelistrikan PLN membagi-bagi fungsi unit induknya kedalam beberapa 
             unit induk berdasarkan pada sistem tenaga listrik yaitu pembangkitan, transmisi, dan distribusi. Selain itu ada juga unit induk atau pusat-pusat lain sebagai penunjang berlangsungnya perusahaan. Karena luasnya cakupan wilayah kerja PLN, maka PLN memiliki unit-unit di seluruh wilayah Indonesia yang mempunyai fungsi masing-masing sesuai dengan unit induknya.
            </div><!-- /.box-body -->
